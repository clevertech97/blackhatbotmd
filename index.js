  ...
  if (config.sessionID && config.sessionID.startsWith('KnightBot!')) {
    try {
      ...
      if (header !== 'KnightBot' || !b64data) {
        throw new Error("❌ Invalid session format. Expected '𝐛𝐥𝐚𝐜𝐤 𝐡𝐚𝐭 𝐛𝐨𝐭 𝐦𝐝!.....'");
      }
      ...
      console.error('📡 Session : ❌ Error processing 𝐛𝐥𝐚𝐜𝐤 𝐡𝐚𝐭 𝐛𝐨𝐭 𝐦𝐝 session:', e.message);
